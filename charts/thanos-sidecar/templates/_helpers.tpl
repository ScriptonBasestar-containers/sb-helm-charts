...
*/}}
{{- define "thanos-sidecar.fullname" -}}
...
helm.sh/chart: {{ include "thanos-sidecar.chart" . }}
{{ include "thanos-sidecar.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "thanos-sidecar.selectorLabels" -}}
app.kubernetes.io/name: {{ include "thanos-sidecar.name" . }}
...
{{- default (include "thanos-sidecar.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "thanos-sidecar.objstoreSecretName" -}}
{{- if .Values.objstore.existingSecret }}
{{- .Values.objstore.existingSecret }}
{{- else }}
{{- include "thanos-sidecar.fullname" . }}-objstore
{{- end }}
{{- end }}
...
*/}}
{{- define "thanos-sidecar.objstoreConfig" -}}
