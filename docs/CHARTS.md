...
[Alertmanager](#alertmanager), [Grafana](#grafana), [Kube State Metrics](#kube-state-metrics), [Loki](#loki), [Node Exporter](#node-exporter), [Prometheus](#prometheus), [Uptime Kuma](#uptime-kuma)
...
**monitoring**: `Alertmanager`, `Grafana`, `Kube State Metrics`, `Node Exporter`, `Prometheus`, `Uptime Kuma`
...
**observability**: `Alertmanager`, `Grafana`, `Kube State Metrics`, `Loki`, `Prometheus`, `Promtail`
...
**prometheus**: `Alertmanager`, `Kube State Metrics`, `Node Exporter`, `Prometheus`
