...
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-12.2.2-green.svg)
...
![Chart Version](https://img.shields.io/badge/chart-0.3.0-blue.svg) ![App Version](https://img.shields.io/badge/app-2.13.3-green.svg)
...
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-v1.122.3-green.svg)
...
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-10.11.3-green.svg)
...
![CI/CD](https://img.shields.io/badge/tag-CI/CD-orange.svg)
![DevOps](https://img.shields.io/badge/tag-DevOps-orange.svg)
![Automation](https://img.shields.io/badge/tag-Automation-orange.svg)
![Chart Version](https://img.shields.io/badge/chart-0.3.0-blue.svg) ![App Version](https://img.shields.io/badge/app-2.528.3-green.svg)

**Description**: Jenkins CI/CD server with pre-built custom image

**Homepage**: [https://www.jenkins.io/](https://www.jenkins.io/)

**Chart Path**: `charts/jenkins`

**Tags**: CI/CD, DevOps, Automation

**Installation**:
```bash
helm install my-jenkins oci://ghcr.io/scriptonbasestar-containers/charts/jenkins
# or
helm install my-jenkins sb-charts/jenkins
```
...
![Chart Version](https://img.shields.io/badge/chart-0.3.0-blue.svg) ![App Version](https://img.shields.io/badge/app-26.4.2-green.svg)
...
![Observability](https://img.shields.io/badge/tag-Observability-orange.svg)
![Monitoring](https://img.shields.io/badge/tag-Monitoring-orange.svg)
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-3.6.1-green.svg)
...
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-31.0.10-green.svg)
...
![Productivity](https://img.shields.io/badge/tag-Productivity-orange.svg)
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-2.19.6-green.svg)
...
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-2.0.2-green.svg)
...
![Security](https://img.shields.io/badge/tag-Security-orange.svg)
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-1.34.3-green.svg)
...
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-6.8-green.svg)
...
![Admin-Tool](https://img.shields.io/badge/tag-Admin-Tool-orange.svg)
![Chart Version](https://img.shields.io/badge/chart-0.3.0-blue.svg) ![App Version](https://img.shields.io/badge/app-5.2.3-green.svg)
...
![Alerting](https://img.shields.io/badge/tag-Alerting-orange.svg)
![Observability](https://img.shields.io/badge/tag-Observability-orange.svg)
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-0.29.0-green.svg)
...
![Chart Version](https://img.shields.io/badge/chart-0.3.0-blue.svg) ![App Version](https://img.shields.io/badge/app-3.9.0-green.svg)
...
![Chart Version](https://img.shields.io/badge/chart-0.3.0-blue.svg) ![App Version](https://img.shields.io/badge/app-8.17.0-green.svg)
...
![Long-Term-Storage](https://img.shields.io/badge/tag-Long-Term-Storage-orange.svg)
![Chart Version](https://img.shields.io/badge/chart-0.3.0-blue.svg) ![App Version](https://img.shields.io/badge/app-2.15.0-green.svg)

**Description**: Grafana Mimir horizontally scalable, highly available long-term storage for Prometheus metrics

**Homepage**: [https://github.com/scriptonbasestar-container/sb-helm-charts](https://github.com/scriptonbasestar-container/sb-helm-charts)

**Chart Path**: `charts/mimir`
...
**Installation**:
```bash
helm install my-mimir oci://ghcr.io/scriptonbasestar-containers/charts/mimir
# or
helm install my-mimir sb-charts/mimir
```
...
![Monitoring](https://img.shields.io/badge/tag-Monitoring-orange.svg)
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-2.9.0-green.svg)
...
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-1.6.39-green.svg)
...
![S3](https://img.shields.io/badge/tag-S3-orange.svg)
![Object-Storage](https://img.shields.io/badge/tag-Object-Storage-orange.svg)
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-RELEASE.2025-10-15T17-29-55Z-green.svg)
...
![Document](https://img.shields.io/badge/tag-Document-orange.svg)
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-7.0.14-green.svg)
...
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-8.4.3-green.svg)
...
![Chart Version](https://img.shields.io/badge/chart-0.3.0-blue.svg) ![App Version](https://img.shields.io/badge/app-1.10.2-green.svg)
...
![Observability](https://img.shields.io/badge/tag-Observability-orange.svg)
![Telemetry](https://img.shields.io/badge/tag-Telemetry-orange.svg)
![Tracing](https://img.shields.io/badge/tag-Tracing-orange.svg)
![Chart Version](https://img.shields.io/badge/chart-0.3.0-blue.svg) ![App Version](https://img.shields.io/badge/app-0.96.0-green.svg)
...
**Installation**:
```bash
helm install my-opentelemetry-collector oci://ghcr.io/scriptonbasestar-containers/charts/opentelemetry-collector
# or
helm install my-opentelemetry-collector sb-charts/opentelemetry-collector
```
...
![SQL](https://img.shields.io/badge/tag-SQL-orange.svg)
![Relational](https://img.shields.io/badge/tag-Relational-orange.svg)
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-16.11-green.svg)
...
![Metrics](https://img.shields.io/badge/tag-Metrics-orange.svg)
![Observability](https://img.shields.io/badge/tag-Observability-orange.svg)
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-3.7.3-green.svg)
...
![Chart Version](https://img.shields.io/badge/chart-0.3.0-blue.svg) ![App Version](https://img.shields.io/badge/app-1.11.2-green.svg)
...
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-3.13.1-green.svg)
...
![Database](https://img.shields.io/badge/tag-Database-orange.svg)
![In-Memory](https://img.shields.io/badge/tag-In-Memory-orange.svg)
![Chart Version](https://img.shields.io/badge/chart-0.4.0-blue.svg) ![App Version](https://img.shields.io/badge/app-7.4.1-green.svg)
...
[Browserless Chrome](#browserless-chrome), [Jenkins](#jenkins)
...
[Elasticsearch](#elasticsearch), [Loki](#loki), [OpenTelemetry Collector](#opentelemetry-collector), [Promtail](#promtail)
...
[Kube State Metrics](#kube-state-metrics), [Grafana Mimir](#mimir), [Node Exporter](#node-exporter), [OpenTelemetry Collector](#opentelemetry-collector), [Prometheus](#prometheus), [Prometheus Pushgateway](#pushgateway)

### Monitoring

[Alertmanager](#alertmanager), [Blackbox Exporter](#blackbox-exporter), [Grafana](#grafana), [Kube State Metrics](#kube-state-metrics), [Loki](#loki), [Grafana Mimir](#mimir), [Node Exporter](#node-exporter), [Prometheus](#prometheus), [Prometheus Pushgateway](#pushgateway), [Grafana Tempo](#tempo), [Uptime Kuma](#uptime-kuma)
...
[Alertmanager](#alertmanager), [Grafana](#grafana), [Loki](#loki), [OpenTelemetry Collector](#opentelemetry-collector), [Prometheus](#prometheus), [Promtail](#promtail), [Grafana Tempo](#tempo)
...
[OpenTelemetry Collector](#opentelemetry-collector), [Grafana Tempo](#tempo)
...
**automation**: `Browserless Chrome`, `Jenkins`
...
**distributed-tracing**: `OpenTelemetry Collector`, `Grafana Tempo`
...
**logging**: `Elasticsearch`, `Loki`, `OpenTelemetry Collector`, `Promtail`

**logs**: `Loki`, `Promtail`

**loki**: `Loki`, `Promtail`

**long-term-storage**: `Grafana Mimir`
...
**metrics**: `Grafana`, `Kube State Metrics`, `Grafana Mimir`, `Node Exporter`, `OpenTelemetry Collector`, `Prometheus`, `Prometheus Pushgateway`
...
**monitoring**: `Alertmanager`, `Blackbox Exporter`, `Grafana`, `Kube State Metrics`, `Grafana Mimir`, `Node Exporter`, `Prometheus`, `Prometheus Pushgateway`, `Uptime Kuma`
...
**observability**: `Alertmanager`, `Blackbox Exporter`, `Grafana`, `Kube State Metrics`, `Loki`, `Grafana Mimir`, `OpenTelemetry Collector`, `Prometheus`, `Promtail`, `Prometheus Pushgateway`, `Grafana Tempo`

**ocr**: `Paperless-ngx`

**opentelemetry**: `OpenTelemetry Collector`, `Grafana Tempo`
...
**prometheus**: `Alertmanager`, `Blackbox Exporter`, `Kube State Metrics`, `Grafana Mimir`, `Node Exporter`, `Prometheus`, `Prometheus Pushgateway`
...
**timeseries**: `Grafana Mimir`, `Prometheus`

**tracing**: `OpenTelemetry Collector`, `Grafana Tempo`
