...
[Alertmanager](#alertmanager), [Grafana](#grafana), [Loki](#loki), [Node Exporter](#node-exporter), [Prometheus](#prometheus), [Uptime Kuma](#uptime-kuma)
...
**monitoring**: `Alertmanager`, `Grafana`, `Node Exporter`, `Prometheus`, `Uptime Kuma`
...
**observability**: `Alertmanager`, `Grafana`, `Loki`, `Prometheus`, `Promtail`
...
**prometheus**: `Alertmanager`, `Node Exporter`, `Prometheus`
